...
class Survey(models.Model):
    cat = (('Yes','Yes'),('no','no'))
    self_employed=models.CharField(max_length=50,choices=cat)
    lost_job=models.CharField(max_length=50,choices=cat)
    health_issues=models.CharField(max_length=50,choices=cat)
    physical_health=models.CharField(max_length=50,choices=cat)
    friends=models.CharField(max_length=50,choices=cat)
    relatives=models.CharField(max_length=50,choices=cat)
    salary_cuts=models.CharField(max_length=50,choices=cat)
    exercise=models.CharField(max_length=50,choices=cat)
    missed_daily_routines=models.CharField(max_length=50,choices=cat)
